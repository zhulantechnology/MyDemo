...
//========================lovelyfonts start========================
    ...
    std::vector<FontFamily*> & getFamilies(){
        return mFamilies;
    }
    FontFamily * getLovelyFonts(){
		return mLovelyFonts;
    }
	void setLovelyFonts(FontFamily * family){
		mLovelyFonts = family;
    }
	FontFamily * getLovelyEmoji(){
		return mLovelyEmoji;
    }
	void setLovelyEmoji(FontFamily * family){
		mLovelyEmoji = family;
    }
#endif
//========================lovelyfonts end  ========================
...
//========================lovelyfonts start========================
#ifdef MEDIATEK_FONTS_FRAMEWORK_SUPPORT
    FontFamily * mLovelyFonts;
    FontFamily * mLovelyEmoji;
#endif
//========================lovelyfonts end  ========================
};
