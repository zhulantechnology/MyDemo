...
//================lovelyfonts start=====================
#ifdef MEDIATEK_FONTS_FRAMEWORK_SUPPORT
    bool getCanBeReplaced(){
        return mCanBeReplaced;
    }
    void setCanBeReplaced(bool can){
        mCanBeReplaced = can ;
    }
    bool getIsLovelyFont(){
        return mLovelyFont;
    }
    void setIsLovelyFont(bool lovely){
        mLovelyFont = lovely ;
    }
	bool getIsLovelyEmojiFont(){
        return mLovelyEmojiFont;
    }
    void setIsLovelyEmojiFont(bool lovely){
        mLovelyEmojiFont = lovely ;
    }
#endif
//================lovelyfonts end=====================
