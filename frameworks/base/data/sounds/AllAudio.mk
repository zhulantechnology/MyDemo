...
#add DWEQLN-246 guowen 20161202 start
ifeq ($(TARGET_PRODUCT), full_d5270_allview_e1)
PRODUCT_COPY_FILES += \
...
else ifeq ($(TARGET_PRODUCT), full_b52010_allview_f1)
PRODUCT_COPY_FILES += \
    $(LOCAL_PATH)/effects/ogg/Dock.ogg:system/media/audio/ui/Dock.ogg \
    $(LOCAL_PATH)/effects/ogg/Effect_Tick_48k.ogg:system/media/audio/ui/Effect_Tick.ogg \
    $(LOCAL_PATH)/effects/ogg/KeypressDelete_120_48k.ogg:system/media/audio/ui/KeypressDelete.ogg \
    ...
    $(LOCAL_PATH)/effects/ogg/camera_click.ogg:system/media/audio/ui/camera_click.ogg \
    $(LOCAL_PATH)/effects/ogg/camera_shutter.ogg:system/media/audio/ui/camera_shutter.ogg
else ifeq ($(findstring _qmobile,$(TARGET_PRODUCT)), _qmobile)
PRODUCT_COPY_FILES += \
$(LOCAL_PATH)/effects/qmobile_ui/audio_end.ogg:system/media/audio/ui/audio_end.ogg \
$(LOCAL_PATH)/effects/qmobile_ui/audio_initiate.ogg:system/media/audio/ui/audio_initiate.ogg \
$(LOCAL_PATH)/effects/qmobile_ui/camera_click.ogg:system/media/audio/ui/camera_click.ogg \
$(LOCAL_PATH)/effects/qmobile_ui/camera_focus.ogg:system/media/audio/ui/camera_focus.ogg \
$(LOCAL_PATH)/effects/qmobile_ui/camera_shutter.ogg:system/media/audio/ui/camera_shutter.ogg \
$(LOCAL_PATH)/effects/qmobile_ui/Dock.ogg:system/media/audio/ui/Dock.ogg \
$(LOCAL_PATH)/effects/qmobile_ui/Effect_Tick.ogg:system/media/audio/ui/Effect_Tick.ogg \
$(LOCAL_PATH)/effects/qmobile_ui/KeypressDelete.ogg:system/media/audio/ui/KeypressDelete.ogg \
$(LOCAL_PATH)/effects/qmobile_ui/KeypressInvalid.ogg:system/media/audio/ui/KeypressInvalid.ogg \
$(LOCAL_PATH)/effects/qmobile_ui/KeypressReturn.ogg:system/media/audio/ui/KeypressReturn.ogg \
$(LOCAL_PATH)/effects/qmobile_ui/KeypressSpacebar.ogg:system/media/audio/ui/KeypressSpacebar.ogg \
$(LOCAL_PATH)/effects/qmobile_ui/KeypressStandard.ogg:system/media/audio/ui/KeypressStandard.ogg \
$(LOCAL_PATH)/effects/qmobile_ui/Lock.ogg:system/media/audio/ui/Lock.ogg \
$(LOCAL_PATH)/effects/qmobile_ui/LowBattery.ogg:system/media/audio/ui/LowBattery.ogg \
$(LOCAL_PATH)/effects/qmobile_ui/NFCFailure.ogg:system/media/audio/ui/NFCFailure.ogg \
$(LOCAL_PATH)/effects/qmobile_ui/NFCInitiated.ogg:system/media/audio/ui/NFCInitiated.ogg \
$(LOCAL_PATH)/effects/qmobile_ui/NFCSuccess.ogg:system/media/audio/ui/NFCSuccess.ogg \
$(LOCAL_PATH)/effects/qmobile_ui/NFCTransferComplete.ogg:system/media/audio/ui/NFCTransferComplete.ogg \
$(LOCAL_PATH)/effects/qmobile_ui/NFCTransferInitiated.ogg:system/media/audio/ui/NFCTransferInitiated.ogg \
$(LOCAL_PATH)/effects/qmobile_ui/Trusted.ogg:system/media/audio/ui/Trusted.ogg \
$(LOCAL_PATH)/effects/qmobile_ui/Undock.ogg:system/media/audio/ui/Undock.ogg \
$(LOCAL_PATH)/effects/qmobile_ui/Unlock.ogg:system/media/audio/ui/Unlock.ogg \
$(LOCAL_PATH)/effects/qmobile_ui/VideoRecord.ogg:system/media/audio/ui/VideoRecord.ogg \
$(LOCAL_PATH)/effects/qmobile_ui/VideoStop.ogg:system/media/audio/ui/VideoStop.ogg \
$(LOCAL_PATH)/effects/qmobile_ui/WirelessChargingStarted.ogg:system/media/audio/ui/WirelessChargingStarted.ogg
else
PRODUCT_COPY_FILES += \
    $(LOCAL_PATH)/effects/ogg/Dock.ogg:system/media/audio/ui/Dock.ogg \
    $(LOCAL_PATH)/effects/ogg/Effect_Tick_48k.ogg:system/media/audio/ui/Effect_Tick.ogg \
...
#add DWEQLN-246 guowen 20161202 end

    #delete  DWEQLSY-530 zhaoyongle 20161014(start)
    ...
    #delete  DWEQLSY-530 zhaoyongle 20161014(end)
